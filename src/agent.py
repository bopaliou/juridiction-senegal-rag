...
# Liste des questions citoyennes - accessibles et pratiques pour les citoyens sénégalais
AUTHORIZED_QUESTIONS = [
    ...
    "Ai-je droit à des congés payés pendant ma première année ?",
    "Que faire si mon contrat n'est pas renouvelé ?",
    ...
    "Quand commence le versement de ma pension ?",
    "Ma pension peut-elle être révisée ?",
    ...
    "Ai-je droit au respect de ma vie privée au travail ?",
    "Peut-on me sanctionner pour mes opinions politiques ?",
    ...
    "Comment régler un conflit avec mon employeur ?",
    "Où trouver de l'aide juridique gratuite ?",
    "Quel tribunal est compétent pour les conflits du travail ?",
]
